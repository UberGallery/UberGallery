...
class ImageTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $png = new Image(__DIR__ . '/test_files/test.png', 0, 0, 'PNG Title');
        $this->assertEquals('PNG Title', $png->title());

        $jpg = new Image(__DIR__ . '/test_files/test.jpg', 0, 0, 'JPG Title');
        $this->assertEquals('JPG Title', $jpg->title());

        $jpeg = new Image(__DIR__ . '/test_files/test.jpeg', 0, 0, 'JPEG Title');
